...
func generateGeometrySceneGenuary2026() -> GeometriesSceneBase {
    var scene = GeometriesSceneBase(
        name: "Genuary 2026",
        inputs: [
            SceneInput(name: "Day", type: .string, inputGroupName: "Day configs", value: "30", presetValues: [
            ...
            SceneInput(name: "Prompt", type: .string, inputGroupName: "Texts", value: "Bugging out."),
    ...
    scene.backgroundColor = SIMD3<Float>(0.01, 0.01, 0.01)
