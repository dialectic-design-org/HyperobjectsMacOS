...
func generateGeometrySceneGenuary2026() -> GeometriesSceneBase {
    var scene = GeometriesSceneBase(
        name: "Genuary 2026",
        inputs: [
            SceneInput(name: "Day", type: .string, inputGroupName: "Day configs", value: "24", presetValues: [
            ...
            SceneInput(name: "Prompt", type: .string, inputGroupName: "Texts", value: "Perfectionist nightmare."),
            ...
            SceneInput(name: "Red", type: .float, value: 0.0, range: 0.0...3.0, audioAmplificationAddition: 1.0),
            SceneInput(name: "Green", type: .float, value: 0.0, range: 0.0...3.0, audioAmplificationAddition: 1.0, audioDelay: 0.1),
            SceneInput(name: "Blue", type: .float, value: 0.0, range: 0.0...3.0, audioAmplificationAddition: 1.0, audioDelay: 0.0),
            ...
            SceneInput(name: "Depth", type: .float, value: 0.0, range: 0.0...3.0, audioAmplificationAddition: 1.0, audioDelay: 0.0),
    ...
    scene.backgroundColor = SIMD3<Float>(0.96, 0.96, 0.96)
