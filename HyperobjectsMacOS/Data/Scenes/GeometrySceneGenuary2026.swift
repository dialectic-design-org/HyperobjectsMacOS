...
func generateGeometrySceneGenuary2026() -> GeometriesSceneBase {
    var scene = GeometriesSceneBase(
        name: "Genuary 2026",
        inputs: [
            SceneInput(name: "Day", type: .string, inputGroupName: "Day configs", value: "26", presetValues: [
            ...
            SceneInput(name: "Prompt", type: .string, inputGroupName: "Texts", value: "Recursivity."),
    ...
    scene.backgroundColor = SIMD3<Float>(0.99, 0.75, 0.0)
