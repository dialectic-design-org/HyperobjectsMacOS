...
func generateGeometrySceneGenuary2026() -> GeometriesSceneBase {
    var scene = GeometriesSceneBase(
        name: "Genuary 2026",
        inputs: [
            SceneInput(name: "Day", type: .string, inputGroupName: "Day configs", value: "20", presetValues: [
            ...
            SceneInput(name: "Prompt", type: .string, inputGroupName: "Texts", value: "A Single Line Only."),
    ...
    scene.backgroundColor = SIMD3<Float>(0.99, 0.99, 0.985)
